...
public class ScissorsCar extends Car {
	
	public static String DEFAULT_SCISSORS_CAR_IMAGE_FILE = "Scissors.gif";
	...
	public ScissorsCar(int maxX, int maxY) {
		super(maxX, maxY);
		type ="Scissors";
		this.MIN_SPEED = 3;
		this.MAX_SPEED = 10;
		this.setRandomSpeed();
		this.setIcon(DEFAULT_SCISSORS_CAR_IMAGE_FILE);
	}
}